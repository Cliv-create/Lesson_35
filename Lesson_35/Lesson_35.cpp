...
public:
	...
	Tree() {} // так как в классе есть €вно объ€вленный конструктор копировани€, приходитс€ и конструктор без параметров €вно делать :)
...
private:
	...
	*/
	...
	bool DegeneracyCheck(Node* root) const {
		...
		// сравниваем количество элементов в левой и правой ветв€х
	...
	// собираем все значени€ из дерева в вектор (in-order обход)
...
int main()
{
	...
	cout << "\n" << bt.GetCount() << "\n";
	// 24 элемента, потому что втора€ сотка не добавилась
